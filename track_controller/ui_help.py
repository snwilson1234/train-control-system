...
from track_controller.custom_widgets import *
...
class UI_Help():
    ...
    def create_anim_btn_feild(field_name : str, anim_btn : AnimatedToggle) -> QGridLayout:
        ...
        layout.addWidget(UI_Help.create_label(field_name, Fonts.subsection_font), 0,0,1,1, Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight)
